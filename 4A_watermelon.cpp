...
// tired and want to start their meal as soon as possible, that's why you should help them and find out, 
// if they can 
//divide the watermelon in the way they want. For sure, each of them should get a part of positive weight.
// Input
...
class Solution {
    ...
    void watermelon(int& weight){
        // for any number, can it be written as the sum of 2 even number 
